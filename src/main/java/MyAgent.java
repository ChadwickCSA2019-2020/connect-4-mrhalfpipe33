...
public class MyAgent extends Agent {
   ...
   */
  public void playMiddleColumn() {
    Connect4Column middleColumn = myGame.getColumn(3);
    if (!middleColumn.getIsFull()) {
      this.moveOnColumn(3);
    }
  }
  /**
   * Returns an ArrayList of all the columns that will not cause the agent to be exposed to losing next round.
   *
   * @return an ArrayList of column numbers that the agent can play on or a -1 if the agent can't play there.
   */
